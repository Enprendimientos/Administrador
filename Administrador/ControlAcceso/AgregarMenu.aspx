...
<body>
  <form id="form1" runat="server">
    ...
    <ext:Hidden runat="server" ID="hid_id" FieldLabel="id"/>
        ...
        <ext:FormPanel runat="server" Region="Center" Padding="10" AutoScroll="True">
          ...
          <Items>
            ...
            <ext:ComboBox runat="server" ID="cmbIconos" FieldLabel="Icono" ValueField="icono" DisplayField="icono" IndicatorIcon="Help"
              IndicatorTip="Los Iconos son Imágenes que se muestra al costado del nombre del Menú" AllowBlank="False" AnchorHorizontal="98%" Editable="true">
              <Store>
                <ext:Store runat="server" ID="strIconos" AutoLoad="True">
                  <Model>
