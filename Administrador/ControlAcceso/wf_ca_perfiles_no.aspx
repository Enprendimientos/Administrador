  ...
  <form id="formTemplate" runat="server">
    ...
    <script type="text/javascript">
      ...
      function ClickLimpiarFiltros() {
        ...
        filtertxt_perf_perfil.reset();
        filterbol_perf_esvigente.reset();
        filtertxt_perf_descripcion.reset();
        filterint_perf_orden.reset();
    ...
    <ext:Viewport ID="viewport" runat="server" Layout="BorderLayout">
      <Items>
        <ext:FormPanel ID="FormPanel1" runat="server" Region="Center" Layout="FitLayout">
          <Items>
            <ext:GridPanel ID="gd_grilla" runat="server" StoreID="st_grilla" Border="false" EnableColumnHide="true">
              <ColumnModel>
                <Columns>
