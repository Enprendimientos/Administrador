      ...
      <StartMenu MinHeight="300" Height="300" Icon="User">
        <ToolConfig>
          <ext:Toolbar ID="Toolbar1" runat="server" Width="125">
            <Items>
              <ext:Button ID="btnMiPerfil" runat="server" Icon="Cog" Text="Mi Perfil">
                <DirectEvents>
                  <Click OnEvent="btnMiPerfil_Click">
              ...
              <ext:Button runat="server" Icon="Key" Text="Cerrar Sesión" ID="btnCerrar">
                <DirectEvents>
                  <Click OnEvent="btnCerrarSesion_Click">
                    ...
                    <Confirmation Message="¿Esta Seguro que desea Cerrar Sesión?" ConfirmRequest="True"/>
                  </Click>
                </DirectEvents>
              </ext:Button>
            </Items>
