...
{
    public class bf_tg_bancos_personas
    {
        public co_tg_bancos_personas GetData(int id)
        {
            try
            {
                br_tg_bancos_personas BRpersonas = new br_tg_bancos_personas();
        ...
        public co_tg_bancos_personas Save(co_tg_bancos_personas personas)
        {
            try
            {
                br_tg_bancos_personas BRpersonas = new br_tg_bancos_personas();
        ...
        public IList<co_tg_bancos_personas> Save(IList<co_tg_bancos_personas> personass)
        {
            try
            {
                br_tg_bancos_personas BRpersonas = new br_tg_bancos_personas();
                List<co_tg_bancos_personas> ObjReturn = new List<co_tg_bancos_personas>();
                foreach (co_tg_bancos_personas of in personass) 
                {
                    if (of.id == 0)
                    {
