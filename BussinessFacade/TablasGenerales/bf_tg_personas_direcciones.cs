...
{
    public class bf_tg_personas_direcciones
    {
        public co_tg_personas_direcciones GetData(int id)
        {
            try
            {
                br_tg_personas_direcciones BRdirecciones = new br_tg_personas_direcciones();
        ...
        public co_tg_personas_direcciones Save(co_tg_personas_direcciones direcciones)
        {
            try
            {
                br_tg_personas_direcciones BRdirecciones = new br_tg_personas_direcciones();
        ...
        public IList<co_tg_personas_direcciones> Save(IList<co_tg_personas_direcciones> direccioness)
        {
            try
            {
                br_tg_personas_direcciones BRdirecciones = new br_tg_personas_direcciones();
                List<co_tg_personas_direcciones> ObjReturn = new List<co_tg_personas_direcciones>();
                foreach (co_tg_personas_direcciones of in direccioness) 
                {
                    if (of.id == 0)
                    {
