...
{
    public class br_tg_direcciones : SCBusinessRules<co_tg_direcciones>
    {
        public br_tg_direcciones(){
             this.myTrans = new FWPTransaction();
        }

        public br_tg_direcciones(FWPTransaction Trans)
        {
            this.myTrans = Trans;
        ...
        public co_tg_direcciones GetData(int id)
        {
            try
            {
                da_tg_direcciones DAdirecciones = new da_tg_direcciones(this.myTrans);
        ...
        {
            IList<co_tg_direcciones> ilistReturn;
            try
            {
