...
{
    public class br_tg_personas : SCBusinessRules<co_tg_personas>
    {
        public br_tg_personas(){
             this.myTrans = new FWPTransaction();
        }

        public br_tg_personas(FWPTransaction Trans)
        {
            this.myTrans = Trans;
        ...
        public co_tg_personas GetData(int id)
        {
            try
            {
                da_tg_personas DApersonas = new da_tg_personas(this.myTrans);
        ...
        {
            IList<co_tg_personas> ilistReturn;
            try
            {
