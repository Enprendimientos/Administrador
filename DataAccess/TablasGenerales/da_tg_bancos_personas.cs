...
{
    public class da_tg_bancos_personas: SCDataAccess<co_tg_bancos_personas>
    {
        public da_tg_bancos_personas(FWPTransaction Transaccion)
        {
        ...
        public co_tg_bancos_personas GetData(int id)
        {
            try
            {
                return this.ReadDataGeneric(id, "pa08_tg_bancos_personas_sel", this.Trans);
            }
            catch (Exception e)
            {
        ...
        public IList<co_tg_bancos_personas> GetData(co_tg_bancos_personas personas)
        {
            try
            {
                return this.ReadDataGeneric(personas, "pa08_tg_bancos_personas_selList", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public co_tg_bancos_personas Insert(co_tg_bancos_personas personas)
        {
            try
            {
                return this.CreateDataGeneric(personas, "pa08_tg_bancos_personas_in", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public void Update(co_tg_bancos_personas personas)
        {
            try
            {
                this.UpdateDataGeneric(personas, "pa08_tg_bancos_personas_ac", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public void Delete(int id)
        {
            try
            {
                this.DeleteDataGeneric(id, "pa08_tg_bancos_personas_ac", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public void Delete(co_tg_bancos_personas personas)
        {
            try
            {
                this.DeleteDataGeneric(personas, "pa08_tg_bancos_personas_ac", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public Nomina<co_tg_bancos_personas_no> GetNomina(co_tg_bancos_personas_no Nomina)
        {
            try
            {
                 SCDataAccessNominas<co_tg_bancos_personas_no> nom = new SCDataAccessNominas<co_tg_bancos_personas_no>();
                 return nom.ReadDataGeneric(Nomina, "pa08_tg_bancos_personas_no", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
