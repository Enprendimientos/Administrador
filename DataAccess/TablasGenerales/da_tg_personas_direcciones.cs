...
{
    public class da_tg_personas_direcciones: SCDataAccess<co_tg_personas_direcciones>
    {
        public da_tg_personas_direcciones(FWPTransaction Transaccion)
        {
        ...
        public co_tg_personas_direcciones GetData(int id)
        {
            try
            {
                return this.ReadDataGeneric(id, "pa08_tg_personas_direcciones_sel", this.Trans);
            }
            catch (Exception e)
            {
        ...
        public IList<co_tg_personas_direcciones> GetData(co_tg_personas_direcciones direcciones)
        {
            try
            {
                return this.ReadDataGeneric(direcciones, "pa08_tg_personas_direcciones_selList", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public co_tg_personas_direcciones Insert(co_tg_personas_direcciones direcciones)
        {
            try
            {
                return this.CreateDataGeneric(direcciones, "pa08_tg_personas_direcciones_in", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public void Update(co_tg_personas_direcciones direcciones)
        {
            try
            {
                this.UpdateDataGeneric(direcciones, "pa08_tg_personas_direcciones_ac", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public void Delete(int id)
        {
            try
            {
                this.DeleteDataGeneric(id, "pa08_tg_personas_direcciones_ac", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public void Delete(co_tg_personas_direcciones direcciones)
        {
            try
            {
                this.DeleteDataGeneric(direcciones, "pa08_tg_personas_direcciones_ac", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
        ...
        public Nomina<co_tg_personas_direcciones_no> GetNomina(co_tg_personas_direcciones_no Nomina)
        {
            try
            {
                 SCDataAccessNominas<co_tg_personas_direcciones_no> nom = new SCDataAccessNominas<co_tg_personas_direcciones_no>();
                 return nom.ReadDataGeneric(Nomina, "pa08_tg_personas_direcciones_no", this.Trans);
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
